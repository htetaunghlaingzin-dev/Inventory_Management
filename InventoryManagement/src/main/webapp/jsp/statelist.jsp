...
<li><a href="statelist.html" class="active">State list</a></li>
</ul>
</li>
<li>
...
<div class="page-btn">
<a href="newstate.html" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-2">Add State</a>
</div>
</div>
