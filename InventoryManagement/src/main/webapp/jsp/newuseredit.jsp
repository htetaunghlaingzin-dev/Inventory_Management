...
<input type="text" name="username" value="${edit.username}" readonly="readonly">
</div>
<div class="form-group">
<label>Email</label>
<input type="text" name="mail" value="${edit.mail}">
</div>
<div class="form-group">
<label>First Name</label>
<input type="text" name="fname" value="${edit.fname}">
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<label>Mobile</label>
<input type="text" name="ph" value="${edit.ph}">
</div>
<div class="form-group">
<label>Role</label>
<select class="select" name="role">
 <option value="sale" ${edit.role == 'sale' ? 'selected' : ''}>Sale</option>
