...
<form action="/InventoryManagement/UserServlet" method="post" enctype="multipart/form-data">
<div class="card">
<div class="card-body">
<div class="row">
...
<input type="password" class=" pass-input" name="pwd">
...
<option name="role" value="sale">Sale</option>
